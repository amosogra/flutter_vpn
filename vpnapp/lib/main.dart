...
class _MyAppState extends State<MyApp> {
  ...
  @override
  void initState() {
    FlutterVpn.prepare(platformAlert: platformAlert);
      ...
      home: Scaffold(
        ...
        body: ListView(
          ...
          children: <Widget>[
            ...
            TextFormField(controller: _addressController, textInputAction: TextInputAction.next, decoration: const InputDecoration(icon: Icon(Icons.map_outlined))),
            TextFormField(
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                var connected = await FlutterVpn.connectIkev2EAP(
            ...
            ElevatedButton(child: const Text('Disconnect'), onPressed: () => FlutterVpn.disconnect()),
            ElevatedButton(onPressed: getCurrentState, child: const Text('Update State')),
            ElevatedButton(onPressed: getCharonErrorState, child: const Text('Update Charon State')),
          ],
        ),
      ),
    );
